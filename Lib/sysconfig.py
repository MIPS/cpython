...
def _generate_posix_vars():
    ...
    if get_platform() == 'win':
        vars['COREPYTHONPATH'] = vars['COREPYTHONPATH'].replace(":",";")
        vars['PYTHONPATH'] = vars['PYTHONPATH'].replace(":",";")
        vars['TKPATH'] = vars['TKPATH'].replace(":",";")
        vars['OLDPATH'] = vars['OLDPATH'].replace(":",";")
        vars['MACHDEPPATH'] = vars['MACHDEPPATH'].replace(":",";")
