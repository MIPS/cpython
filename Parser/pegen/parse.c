...
#define call_stmt_type 1012
#define simple_primary_type 1013  // Left-recursive
#define assignment_type 1014
#define augassign_type 1015
...
#define if_stmt_type 1030
#define elif_stmt_type 1031
#define else_block_type 1032
...
#define expressions_list_type 1061
#define star_expressions_type 1062
#define star_expression_type 1063
#define star_named_expressions_type 1064
#define star_named_expression_type 1065
#define named_expression_type 1066
#define annotated_rhs_type 1067
#define expressions_type 1068
#define expression_type 1069
#define lambdef_type 1070
...
#define del_target_end_type 1139
...
#define incorrect_arguments_type 1145
...
#define _tmp_25_type 1182
#define _tmp_26_type 1183
#define _loop1_27_type 1184
#define _tmp_28_type 1185
...
#define _loop0_35_type 1192
#define _loop1_36_type 1193
#define _loop0_38_type 1194
#define _gather_37_type 1195
#define _tmp_39_type 1196
...
#define _loop0_48_type 1204
#define _gather_47_type 1205
#define _loop0_50_type 1206
#define _gather_49_type 1207
#define _tmp_51_type 1208
#define _loop1_52_type 1209
#define _tmp_53_type 1210
#define _tmp_54_type 1211
#define _tmp_55_type 1212
#define _tmp_56_type 1213
#define _tmp_57_type 1214
#define _loop0_58_type 1215
#define _loop0_59_type 1216
#define _loop0_60_type 1217
...
#define _loop1_69_type 1226
#define _loop0_70_type 1227
#define _loop1_71_type 1228
#define _loop1_72_type 1229
#define _tmp_73_type 1230
#define _loop0_75_type 1231
#define _gather_74_type 1232
#define _loop1_76_type 1233
#define _loop0_78_type 1234
#define _gather_77_type 1235
#define _loop1_79_type 1236
#define _loop0_80_type 1237
#define _loop0_81_type 1238
#define _loop0_82_type 1239
...
#define _loop0_90_type 1247
#define _loop1_91_type 1248
#define _loop0_92_type 1249
#define _loop1_93_type 1250
#define _loop1_94_type 1251
#define _loop1_95_type 1252
#define _loop1_96_type 1253
#define _tmp_97_type 1254
#define _loop0_99_type 1255
#define _gather_98_type 1256
#define _tmp_100_type 1257
#define _tmp_101_type 1258
#define _tmp_102_type 1259
#define _tmp_103_type 1260
#define _loop1_104_type 1261
#define _tmp_105_type 1262
#define _tmp_106_type 1263
#define _loop0_108_type 1264
#define _gather_107_type 1265
#define _loop1_109_type 1266
#define _loop0_110_type 1267
#define _loop0_111_type 1268
#define _tmp_112_type 1269
#define _tmp_113_type 1270
...
#define _loop0_121_type 1277
#define _gather_120_type 1278
#define _loop0_122_type 1279
#define _loop0_124_type 1280
#define _gather_123_type 1281
#define _tmp_125_type 1282
#define _loop0_127_type 1283
#define _gather_126_type 1284
#define _loop0_129_type 1285
#define _gather_128_type 1286
#define _tmp_130_type 1287
#define _loop0_131_type 1288
#define _tmp_132_type 1289
#define _loop0_133_type 1290
#define _loop0_134_type 1291
#define _tmp_135_type 1292
#define _tmp_136_type 1293
#define _loop0_137_type 1294
...
#define _tmp_151_type 1308
#define _tmp_152_type 1309
#define _tmp_153_type 1310
#define _loop1_154_type 1311
#define _tmp_155_type 1312
#define _tmp_156_type 1313
...
static stmt_ty call_stmt_rule(Parser *p);
static expr_ty simple_primary_rule(Parser *p);
...
small_stmt_rule(Parser *p)
{
    ...
    { // star_expressions &(';' | NEWLINE)
        ...
        D(fprintf(stderr, "%*c> small_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_expressions &(';' | NEWLINE)"));
        expr_ty e;
        if (
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s small_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_expressions &(';' | NEWLINE)"));
    }
    { // &'return' return_stmt
        if (p->error_indicator) {
            D(p->level--);
    ...
    { // call_stmt
        ...
        D(fprintf(stderr, "%*c> small_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "call_stmt"));
        stmt_ty call_stmt_var;
        if (
            (call_stmt_var = call_stmt_rule(p))  // call_stmt
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "call_stmt"));
            _res = call_stmt_var;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s small_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "call_stmt"));
    }
    _res = NULL;
  done:
...
// call_stmt: simple_primary &(NAME | NUMBER | STRING) args
static stmt_ty
call_stmt_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    int _start_col_offset = p->tokens[_mark]->col_offset;
    UNUSED(_start_col_offset); // Only used by EXTRA macro
    { // simple_primary &(NAME | NUMBER | STRING) args
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> call_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "simple_primary &(NAME | NUMBER | STRING) args"));
        expr_ty a;
        expr_ty b;
        if (
            (a = simple_primary_rule(p))  // simple_primary
            &&
            _PyPegen_lookahead(1, _tmp_20_rule, p)
            &&
            (b = args_rule(p))  // args
        )
        {
            D(fprintf(stderr, "%*c+ call_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "simple_primary &(NAME | NUMBER | STRING) args"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_Expr ( _Py_Call ( a , ( b ) ? ( ( expr_ty ) b ) -> v . Call . args : NULL , ( b ) ? ( ( expr_ty ) b ) -> v . Call . keywords : NULL , EXTRA ) , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s call_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "simple_primary &(NAME | NUMBER | STRING) args"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// simple_primary:
//     | simple_primary '.' NAME
//     | simple_primary genexp &('.' | '(' | '[')
//     | simple_primary '(' arguments? ')' &('.' | '(' | '[')
//     | simple_primary '[' slices ']' &('.' | '(' | '[')
//     | NAME
static expr_ty simple_primary_raw(Parser *);
static expr_ty
simple_primary_rule(Parser *p)
{
    D(p->level++);
    expr_ty _res = NULL;
    if (_PyPegen_is_memoized(p, simple_primary_type, &_res)) {
        D(p->level--);
        return _res;
    }
    int _mark = p->mark;
    int _resmark = p->mark;
    while (1) {
        int tmpvar_0 = _PyPegen_update_memo(p, _mark, simple_primary_type, _res);
        if (tmpvar_0) {
            D(p->level--);
            return _res;
        }
        p->mark = _mark;
        void *_raw = simple_primary_raw(p);
...
simple_primary_raw(Parser *p)
{
    ...
    { // simple_primary '.' NAME
        ...
        D(fprintf(stderr, "%*c> simple_primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "simple_primary '.' NAME"));
        Token * _literal;
        expr_ty a;
        expr_ty b;
        if (
        ...
        {
            D(fprintf(stderr, "%*c+ simple_primary[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "simple_primary '.' NAME"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s simple_primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "simple_primary '.' NAME"));
    }
    { // simple_primary genexp &('.' | '(' | '[')
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> simple_primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "simple_primary genexp &('.' | '(' | '[')"));
        expr_ty a;
        expr_ty b;
        if (
            (a = simple_primary_rule(p))  // simple_primary
            ...
            &&
            _PyPegen_lookahead(1, _tmp_21_rule, p)
        )
        {
            D(fprintf(stderr, "%*c+ simple_primary[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "simple_primary genexp &('.' | '(' | '[')"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s simple_primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "simple_primary genexp &('.' | '(' | '[')"));
    }
    { // simple_primary '(' arguments? ')' &('.' | '(' | '[')
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> simple_primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "simple_primary '(' arguments? ')' &('.' | '(' | '[')"));
        Token * _literal;
        Token * _literal_1;
        expr_ty a;
        void *b;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s simple_primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "simple_primary '(' arguments? ')' &('.' | '(' | '[')"));
    }
    { // simple_primary '[' slices ']' &('.' | '(' | '[')
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> simple_primary[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "simple_primary '[' slices ']' &('.' | '(' | '[')"));
        Token * _literal;
        Token * _literal_1;
        expr_ty a;
        expr_ty b;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s simple_primary[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "simple_primary '[' slices ']' &('.' | '(' | '[')"));
    }
    { // NAME
        if (p->error_indicator) {
            D(p->level--);
...
assignment_rule(Parser *p)
{
    ...
    { // ('(' single_target ')' | single_subscript_attribute_target) ':' expression ['=' annotated_rhs]
        ...
        void *c;
        if (
            (a = _tmp_25_rule(p))  // '(' single_target ')' | single_subscript_attribute_target
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            &&
            (b = expression_rule(p))  // expression
            &&
            (c = _tmp_26_rule(p), 1)  // ['=' annotated_rhs]
        )
        {
            D(fprintf(stderr, "%*c+ assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "('(' single_target ')' | single_subscript_attribute_target) ':' expression ['=' annotated_rhs]"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // ((star_targets '='))+ (yield_expr | star_expressions) !'=' TYPE_COMMENT?
        ...
        void *tc;
        if (
            (a = _loop1_27_rule(p))  // ((star_targets '='))+
            &&
            (b = _tmp_28_rule(p))  // yield_expr | star_expressions
            &&
    ...
    { // single_target augassign (yield_expr | star_expressions)
        ...
        if (
            ...
            &&
            (c = _tmp_29_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "single_target augassign (yield_expr | star_expressions)"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
...
import_from_as_names_rule(Parser *p)
{
    ...
    { // ','.import_from_as_name+
        ...
        asdl_seq * a;
        if (
            (a = _gather_37_rule(p))  // ','.import_from_as_name+
        )
        {
...
dotted_as_names_rule(Parser *p)
{
    ...
    { // ','.dotted_as_name+
        ...
        asdl_seq * a;
        if (
            (a = _gather_40_rule(p))  // ','.dotted_as_name+
        )
        {
...
// _tmp_25: '(' single_target ')' | single_subscript_attribute_target
static void *
...
_loop1_27_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_27_type, _seq);
    D(p->level--);
    return _seq;
}
...
// _tmp_29: yield_expr | star_expressions
static void *
...
_gather_30_rule(Parser *p)
{
    ...
    { // NAME _loop0_31
        ...
        D(fprintf(stderr, "%*c> _gather_30[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NAME _loop0_31"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = _PyPegen_name_token(p))  // NAME
        ...
        D(fprintf(stderr, "%*c%s _gather_30[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NAME _loop0_31"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_32_rule(Parser *p)
{
    ...
    { // NAME _loop0_33
        ...
        D(fprintf(stderr, "%*c> _gather_32[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NAME _loop0_33"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = _PyPegen_name_token(p))  // NAME
        ...
        D(fprintf(stderr, "%*c%s _gather_32[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NAME _loop0_33"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop1_36_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_36_type, _seq);
    D(p->level--);
    return _seq;
}

// _loop0_38: ',' import_from_as_name
static asdl_seq *
...
// _gather_37: import_from_as_name _loop0_38
static asdl_seq *
_gather_37_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // import_from_as_name _loop0_38
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_37[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "import_from_as_name _loop0_38"));
        alias_ty elem;
        asdl_seq * seq;
        if (
            (elem = import_from_as_name_rule(p))  // import_from_as_name
        ...
        D(fprintf(stderr, "%*c%s _gather_37[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "import_from_as_name _loop0_38"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _gather_40: dotted_as_name _loop0_41
static asdl_seq *
_gather_40_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // dotted_as_name _loop0_41
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_40[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "dotted_as_name _loop0_41"));
        alias_ty elem;
        asdl_seq * seq;
        if (
            (elem = dotted_as_name_rule(p))  // dotted_as_name
        ...
        D(fprintf(stderr, "%*c%s _gather_40[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "dotted_as_name _loop0_41"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop1_72_rule(Parser *p)
{
    ...
    { // ('@' named_expression NEWLINE)
        ...
        void *_tmp_144_var;
        while (
            (_tmp_144_var = _tmp_144_rule(p))  // '@' named_expression NEWLINE
        )
        {
            _res = _tmp_144_var;
            if (_n == _children_capacity) {
...
_loop1_76_rule(Parser *p)
{
    ...
    { // (',' star_expression)
        ...
        void *_tmp_145_var;
        while (
            (_tmp_145_var = _tmp_145_rule(p))  // ',' star_expression
        )
        {
            _res = _tmp_145_var;
            if (_n == _children_capacity) {
...
_loop1_79_rule(Parser *p)
{
    ...
    { // (',' expression)
        ...
        void *_tmp_146_var;
        while (
            (_tmp_146_var = _tmp_146_rule(p))  // ',' expression
        )
        {
            _res = _tmp_146_var;
            if (_n == _children_capacity) {
...
_loop1_94_rule(Parser *p)
{
    ...
    { // ('or' conjunction)
        ...
        void *_tmp_147_var;
        while (
            (_tmp_147_var = _tmp_147_rule(p))  // 'or' conjunction
        )
        {
            _res = _tmp_147_var;
            if (_n == _children_capacity) {
...
_loop1_95_rule(Parser *p)
{
    ...
    { // ('and' inversion)
        ...
        void *_tmp_148_var;
        while (
            (_tmp_148_var = _tmp_148_rule(p))  // 'and' inversion
        )
        {
            _res = _tmp_148_var;
            if (_n == _children_capacity) {
...
// _tmp_144: '@' named_expression NEWLINE
static void *
